...
function generarInforme(array $histograma, string $centro, int $nUsuarios)
{
    ...
    $textrun->addText('(Recomendación 2006/962/CE del Parlamento Europeo y del Consejo, de 18 de diciembre de 2006,', array_merge($estilo, ['size' => 7, 'bgColor' => 'efefef']), ['align' => 'right','pageBreakBefore' => true]);
    $textrun = $section->addTextRun();
    $textrun->addText('sobre las competencias clave para el aprendizaje permanente, Diario Oficial L 394 de 30.12.2006).', array_merge($estilo, ['size' => 7, 'bgColor' => 'efefef']), ['align' => 'right','pageBreakBefore' => true]);
